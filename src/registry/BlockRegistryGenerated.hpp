...
// TODO: generate block specific settings
namespace Blocks
{
    const Block ACACIA_BUTTON("acacia_button", Block::BlockSetting());
    const Block ACACIA_DOOR("acacia_door", Block::BlockSetting());
    const Block ACACIA_FENCE("acacia_fence", Block::BlockSetting());
    const Block ACACIA_FENCE_GATE("acacia_fence_gate", Block::BlockSetting());
    const Block ACACIA_HANGING_SIGN("acacia_hanging_sign", Block::BlockSetting());
    const Block ACACIA_LEAVES("acacia_leaves", Block::BlockSetting());
    const Block ACACIA_LOG("acacia_log", Block::BlockSetting());
    const Block ACACIA_PLANKS("acacia_planks", Block::BlockSetting());
    const Block ACACIA_PRESSURE_PLATE("acacia_pressure_plate", Block::BlockSetting());
    const Block ACACIA_SAPLING("acacia_sapling", Block::BlockSetting());
    const Block ACACIA_SIGN("acacia_sign", Block::BlockSetting());
    const Block ACACIA_SLAB("acacia_slab", Block::BlockSetting());
    const Block ACACIA_STAIRS("acacia_stairs", Block::BlockSetting());
    const Block ACACIA_TRAPDOOR("acacia_trapdoor", Block::BlockSetting());
    const Block ACACIA_WALL_HANGING_SIGN("acacia_wall_hanging_sign", Block::BlockSetting());
    const Block ACACIA_WALL_SIGN("acacia_wall_sign", Block::BlockSetting());
    const Block ACACIA_WOOD("acacia_wood", Block::BlockSetting());
    const Block ACTIVATOR_RAIL("activator_rail", Block::BlockSetting());
    const Block AIR("air", Block::BlockSetting());
    const Block ALLIUM("allium", Block::BlockSetting());
    const Block AMETHYST_BLOCK("amethyst_block", Block::BlockSetting());
    const Block AMETHYST_CLUSTER("amethyst_cluster", Block::BlockSetting());
    const Block ANCIENT_DEBRIS("ancient_debris", Block::BlockSetting());
    const Block ANDESITE("andesite", Block::BlockSetting());
    const Block ANDESITE_SLAB("andesite_slab", Block::BlockSetting());
    const Block ANDESITE_STAIRS("andesite_stairs", Block::BlockSetting());
    const Block ANDESITE_WALL("andesite_wall", Block::BlockSetting());
    const Block ANVIL("anvil", Block::BlockSetting());
    const Block ATTACHED_MELON_STEM("attached_melon_stem", Block::BlockSetting());
    const Block ATTACHED_PUMPKIN_STEM("attached_pumpkin_stem", Block::BlockSetting());
    const Block AZALEA("azalea", Block::BlockSetting());
    const Block AZALEA_LEAVES("azalea_leaves", Block::BlockSetting());
    const Block AZURE_BLUET("azure_bluet", Block::BlockSetting());
    const Block BAMBOO("bamboo", Block::BlockSetting());
    const Block BAMBOO_BLOCK("bamboo_block", Block::BlockSetting());
    const Block BAMBOO_BUTTON("bamboo_button", Block::BlockSetting());
    const Block BAMBOO_DOOR("bamboo_door", Block::BlockSetting());
    const Block BAMBOO_FENCE("bamboo_fence", Block::BlockSetting());
    const Block BAMBOO_FENCE_GATE("bamboo_fence_gate", Block::BlockSetting());
    const Block BAMBOO_HANGING_SIGN("bamboo_hanging_sign", Block::BlockSetting());
    const Block BAMBOO_MOSAIC("bamboo_mosaic", Block::BlockSetting());
    const Block BAMBOO_MOSAIC_SLAB("bamboo_mosaic_slab", Block::BlockSetting());
    const Block BAMBOO_MOSAIC_STAIRS("bamboo_mosaic_stairs", Block::BlockSetting());
    const Block BAMBOO_PLANKS("bamboo_planks", Block::BlockSetting());
    const Block BAMBOO_PRESSURE_PLATE("bamboo_pressure_plate", Block::BlockSetting());
    const Block BAMBOO_SAPLING("bamboo_sapling", Block::BlockSetting());
    const Block BAMBOO_SIGN("bamboo_sign", Block::BlockSetting());
    const Block BAMBOO_SLAB("bamboo_slab", Block::BlockSetting());
    const Block BAMBOO_STAIRS("bamboo_stairs", Block::BlockSetting());
    const Block BAMBOO_TRAPDOOR("bamboo_trapdoor", Block::BlockSetting());
    const Block BAMBOO_WALL_HANGING_SIGN("bamboo_wall_hanging_sign", Block::BlockSetting());
    const Block BAMBOO_WALL_SIGN("bamboo_wall_sign", Block::BlockSetting());
    const Block BARREL("barrel", Block::BlockSetting());
    const Block BARRIER("barrier", Block::BlockSetting());
    const Block BASALT("basalt", Block::BlockSetting());
    const Block BEACON("beacon", Block::BlockSetting());
    const Block BEDROCK("bedrock", Block::BlockSetting());
    const Block BEE_NEST("bee_nest", Block::BlockSetting());
    const Block BEEHIVE("beehive", Block::BlockSetting());
    const Block BEETROOTS("beetroots", Block::BlockSetting());
    const Block BELL("bell", Block::BlockSetting());
    const Block BIG_DRIPLEAF("big_dripleaf", Block::BlockSetting());
    const Block BIG_DRIPLEAF_STEM("big_dripleaf_stem", Block::BlockSetting());
    const Block BIRCH_BUTTON("birch_button", Block::BlockSetting());
    const Block BIRCH_DOOR("birch_door", Block::BlockSetting());
    const Block BIRCH_FENCE("birch_fence", Block::BlockSetting());
    const Block BIRCH_FENCE_GATE("birch_fence_gate", Block::BlockSetting());
    const Block BIRCH_HANGING_SIGN("birch_hanging_sign", Block::BlockSetting());
    const Block BIRCH_LEAVES("birch_leaves", Block::BlockSetting());
    const Block BIRCH_LOG("birch_log", Block::BlockSetting());
    const Block BIRCH_PLANKS("birch_planks", Block::BlockSetting());
    const Block BIRCH_PRESSURE_PLATE("birch_pressure_plate", Block::BlockSetting());
    const Block BIRCH_SAPLING("birch_sapling", Block::BlockSetting());
    const Block BIRCH_SIGN("birch_sign", Block::BlockSetting());
    const Block BIRCH_SLAB("birch_slab", Block::BlockSetting());
    const Block BIRCH_STAIRS("birch_stairs", Block::BlockSetting());
    const Block BIRCH_TRAPDOOR("birch_trapdoor", Block::BlockSetting());
    const Block BIRCH_WALL_HANGING_SIGN("birch_wall_hanging_sign", Block::BlockSetting());
    const Block BIRCH_WALL_SIGN("birch_wall_sign", Block::BlockSetting());
    const Block BIRCH_WOOD("birch_wood", Block::BlockSetting());
    const Block BLACK_BANNER("black_banner", Block::BlockSetting());
    const Block BLACK_BED("black_bed", Block::BlockSetting());
    const Block BLACK_CANDLE("black_candle", Block::BlockSetting());
    const Block BLACK_CANDLE_CAKE("black_candle_cake", Block::BlockSetting());
    const Block BLACK_CARPET("black_carpet", Block::BlockSetting());
    const Block BLACK_CONCRETE("black_concrete", Block::BlockSetting());
    const Block BLACK_CONCRETE_POWDER("black_concrete_powder", Block::BlockSetting());
    const Block BLACK_GLAZED_TERRACOTTA("black_glazed_terracotta", Block::BlockSetting());
    const Block BLACK_SHULKER_BOX("black_shulker_box", Block::BlockSetting());
    const Block BLACK_STAINED_GLASS("black_stained_glass", Block::BlockSetting());
    const Block BLACK_STAINED_GLASS_PANE("black_stained_glass_pane", Block::BlockSetting());
    const Block BLACK_TERRACOTTA("black_terracotta", Block::BlockSetting());
    const Block BLACK_WALL_BANNER("black_wall_banner", Block::BlockSetting());
    const Block BLACK_WOOL("black_wool", Block::BlockSetting());
    const Block BLACKSTONE("blackstone", Block::BlockSetting());
    const Block BLACKSTONE_SLAB("blackstone_slab", Block::BlockSetting());
    const Block BLACKSTONE_STAIRS("blackstone_stairs", Block::BlockSetting());
    const Block BLACKSTONE_WALL("blackstone_wall", Block::BlockSetting());
    const Block BLAST_FURNACE("blast_furnace", Block::BlockSetting());
    const Block BLUE_BANNER("blue_banner", Block::BlockSetting());
    const Block BLUE_BED("blue_bed", Block::BlockSetting());
    const Block BLUE_CANDLE("blue_candle", Block::BlockSetting());
    const Block BLUE_CANDLE_CAKE("blue_candle_cake", Block::BlockSetting());
    const Block BLUE_CARPET("blue_carpet", Block::BlockSetting());
    const Block BLUE_CONCRETE("blue_concrete", Block::BlockSetting());
    const Block BLUE_CONCRETE_POWDER("blue_concrete_powder", Block::BlockSetting());
    const Block BLUE_GLAZED_TERRACOTTA("blue_glazed_terracotta", Block::BlockSetting());
    const Block BLUE_ICE("blue_ice", Block::BlockSetting());
    const Block BLUE_ORCHID("blue_orchid", Block::BlockSetting());
    const Block BLUE_SHULKER_BOX("blue_shulker_box", Block::BlockSetting());
    const Block BLUE_STAINED_GLASS("blue_stained_glass", Block::BlockSetting());
    const Block BLUE_STAINED_GLASS_PANE("blue_stained_glass_pane", Block::BlockSetting());
    const Block BLUE_TERRACOTTA("blue_terracotta", Block::BlockSetting());
    const Block BLUE_WALL_BANNER("blue_wall_banner", Block::BlockSetting());
    const Block BLUE_WOOL("blue_wool", Block::BlockSetting());
    const Block BONE_BLOCK("bone_block", Block::BlockSetting());
    const Block BOOKSHELF("bookshelf", Block::BlockSetting());
    const Block BRAIN_CORAL("brain_coral", Block::BlockSetting());
    const Block BRAIN_CORAL_BLOCK("brain_coral_block", Block::BlockSetting());
    const Block BRAIN_CORAL_FAN("brain_coral_fan", Block::BlockSetting());
    const Block BRAIN_CORAL_WALL_FAN("brain_coral_wall_fan", Block::BlockSetting());
    const Block BREWING_STAND("brewing_stand", Block::BlockSetting());
    const Block BRICK_SLAB("brick_slab", Block::BlockSetting());
    const Block BRICK_STAIRS("brick_stairs", Block::BlockSetting());
    const Block BRICK_WALL("brick_wall", Block::BlockSetting());
    const Block BRICKS("bricks", Block::BlockSetting());
    const Block BROWN_BANNER("brown_banner", Block::BlockSetting());
    const Block BROWN_BED("brown_bed", Block::BlockSetting());
    const Block BROWN_CANDLE("brown_candle", Block::BlockSetting());
    const Block BROWN_CANDLE_CAKE("brown_candle_cake", Block::BlockSetting());
    const Block BROWN_CARPET("brown_carpet", Block::BlockSetting());
    const Block BROWN_CONCRETE("brown_concrete", Block::BlockSetting());
    const Block BROWN_CONCRETE_POWDER("brown_concrete_powder", Block::BlockSetting());
    const Block BROWN_GLAZED_TERRACOTTA("brown_glazed_terracotta", Block::BlockSetting());
    const Block BROWN_MUSHROOM("brown_mushroom", Block::BlockSetting());
    const Block BROWN_MUSHROOM_BLOCK("brown_mushroom_block", Block::BlockSetting());
    const Block BROWN_SHULKER_BOX("brown_shulker_box", Block::BlockSetting());
    const Block BROWN_STAINED_GLASS("brown_stained_glass", Block::BlockSetting());
    const Block BROWN_STAINED_GLASS_PANE("brown_stained_glass_pane", Block::BlockSetting());
    const Block BROWN_TERRACOTTA("brown_terracotta", Block::BlockSetting());
    const Block BROWN_WALL_BANNER("brown_wall_banner", Block::BlockSetting());
    const Block BROWN_WOOL("brown_wool", Block::BlockSetting());
    const Block BUBBLE_COLUMN("bubble_column", Block::BlockSetting());
    const Block BUBBLE_CORAL("bubble_coral", Block::BlockSetting());
    const Block BUBBLE_CORAL_BLOCK("bubble_coral_block", Block::BlockSetting());
    const Block BUBBLE_CORAL_FAN("bubble_coral_fan", Block::BlockSetting());
    const Block BUBBLE_CORAL_WALL_FAN("bubble_coral_wall_fan", Block::BlockSetting());
    const Block BUDDING_AMETHYST("budding_amethyst", Block::BlockSetting());
    const Block BUSH("bush", Block::BlockSetting());
    const Block CACTUS("cactus", Block::BlockSetting());
    const Block CACTUS_FLOWER("cactus_flower", Block::BlockSetting());
    const Block CAKE("cake", Block::BlockSetting());
    const Block CALCITE("calcite", Block::BlockSetting());
    const Block CALIBRATED_SCULK_SENSOR("calibrated_sculk_sensor", Block::BlockSetting());
    const Block CAMPFIRE("campfire", Block::BlockSetting());
    const Block CANDLE("candle", Block::BlockSetting());
    const Block CANDLE_CAKE("candle_cake", Block::BlockSetting());
    const Block CARROTS("carrots", Block::BlockSetting());
    const Block CARTOGRAPHY_TABLE("cartography_table", Block::BlockSetting());
    const Block CARVED_PUMPKIN("carved_pumpkin", Block::BlockSetting());
    const Block CAULDRON("cauldron", Block::BlockSetting());
    const Block CAVE_AIR("cave_air", Block::BlockSetting());
    const Block CAVE_VINES("cave_vines", Block::BlockSetting());
    const Block CAVE_VINES_PLANT("cave_vines_plant", Block::BlockSetting());
    const Block CHAIN("chain", Block::BlockSetting());
    const Block CHAIN_COMMAND_BLOCK("chain_command_block", Block::BlockSetting());
    const Block CHERRY_BUTTON("cherry_button", Block::BlockSetting());
    const Block CHERRY_DOOR("cherry_door", Block::BlockSetting());
    const Block CHERRY_FENCE("cherry_fence", Block::BlockSetting());
    const Block CHERRY_FENCE_GATE("cherry_fence_gate", Block::BlockSetting());
    const Block CHERRY_HANGING_SIGN("cherry_hanging_sign", Block::BlockSetting());
    const Block CHERRY_LEAVES("cherry_leaves", Block::BlockSetting());
    const Block CHERRY_LOG("cherry_log", Block::BlockSetting());
    const Block CHERRY_PLANKS("cherry_planks", Block::BlockSetting());
    const Block CHERRY_PRESSURE_PLATE("cherry_pressure_plate", Block::BlockSetting());
    const Block CHERRY_SAPLING("cherry_sapling", Block::BlockSetting());
    const Block CHERRY_SIGN("cherry_sign", Block::BlockSetting());
    const Block CHERRY_SLAB("cherry_slab", Block::BlockSetting());
    const Block CHERRY_STAIRS("cherry_stairs", Block::BlockSetting());
    const Block CHERRY_TRAPDOOR("cherry_trapdoor", Block::BlockSetting());
    const Block CHERRY_WALL_HANGING_SIGN("cherry_wall_hanging_sign", Block::BlockSetting());
    const Block CHERRY_WALL_SIGN("cherry_wall_sign", Block::BlockSetting());
    const Block CHERRY_WOOD("cherry_wood", Block::BlockSetting());
    const Block CHEST("chest", Block::BlockSetting());
    const Block CHIPPED_ANVIL("chipped_anvil", Block::BlockSetting());
    const Block CHISELED_BOOKSHELF("chiseled_bookshelf", Block::BlockSetting());
    const Block CHISELED_COPPER("chiseled_copper", Block::BlockSetting());
    const Block CHISELED_DEEPSLATE("chiseled_deepslate", Block::BlockSetting());
    const Block CHISELED_NETHER_BRICKS("chiseled_nether_bricks", Block::BlockSetting());
    const Block CHISELED_POLISHED_BLACKSTONE("chiseled_polished_blackstone", Block::BlockSetting());
    const Block CHISELED_QUARTZ_BLOCK("chiseled_quartz_block", Block::BlockSetting());
    const Block CHISELED_RED_SANDSTONE("chiseled_red_sandstone", Block::BlockSetting());
    const Block CHISELED_RESIN_BRICKS("chiseled_resin_bricks", Block::BlockSetting());
    const Block CHISELED_SANDSTONE("chiseled_sandstone", Block::BlockSetting());
    const Block CHISELED_STONE_BRICKS("chiseled_stone_bricks", Block::BlockSetting());
    const Block CHISELED_TUFF("chiseled_tuff", Block::BlockSetting());
    const Block CHISELED_TUFF_BRICKS("chiseled_tuff_bricks", Block::BlockSetting());
    const Block CHORUS_FLOWER("chorus_flower", Block::BlockSetting());
    const Block CHORUS_PLANT("chorus_plant", Block::BlockSetting());
    const Block CLAY("clay", Block::BlockSetting());
    const Block CLOSED_EYEBLOSSOM("closed_eyeblossom", Block::BlockSetting());
    const Block COAL_BLOCK("coal_block", Block::BlockSetting());
    const Block COAL_ORE("coal_ore", Block::BlockSetting());
    const Block COARSE_DIRT("coarse_dirt", Block::BlockSetting());
    const Block COBBLED_DEEPSLATE("cobbled_deepslate", Block::BlockSetting());
    const Block COBBLED_DEEPSLATE_SLAB("cobbled_deepslate_slab", Block::BlockSetting());
    const Block COBBLED_DEEPSLATE_STAIRS("cobbled_deepslate_stairs", Block::BlockSetting());
    const Block COBBLED_DEEPSLATE_WALL("cobbled_deepslate_wall", Block::BlockSetting());
    const Block COBBLESTONE("cobblestone", Block::BlockSetting());
    const Block COBBLESTONE_SLAB("cobblestone_slab", Block::BlockSetting());
    const Block COBBLESTONE_STAIRS("cobblestone_stairs", Block::BlockSetting());
    const Block COBBLESTONE_WALL("cobblestone_wall", Block::BlockSetting());
    const Block COBWEB("cobweb", Block::BlockSetting());
    const Block COCOA("cocoa", Block::BlockSetting());
    const Block COMMAND_BLOCK("command_block", Block::BlockSetting());
    const Block COMPARATOR("comparator", Block::BlockSetting());
    const Block COMPOSTER("composter", Block::BlockSetting());
    const Block CONDUIT("conduit", Block::BlockSetting());
    const Block COPPER_BLOCK("copper_block", Block::BlockSetting());
    const Block COPPER_BULB("copper_bulb", Block::BlockSetting());
    const Block COPPER_DOOR("copper_door", Block::BlockSetting());
    const Block COPPER_GRATE("copper_grate", Block::BlockSetting());
    const Block COPPER_ORE("copper_ore", Block::BlockSetting());
    const Block COPPER_TRAPDOOR("copper_trapdoor", Block::BlockSetting());
    const Block CORNFLOWER("cornflower", Block::BlockSetting());
    const Block CRACKED_DEEPSLATE_BRICKS("cracked_deepslate_bricks", Block::BlockSetting());
    const Block CRACKED_DEEPSLATE_TILES("cracked_deepslate_tiles", Block::BlockSetting());
    const Block CRACKED_NETHER_BRICKS("cracked_nether_bricks", Block::BlockSetting());
    const Block CRACKED_POLISHED_BLACKSTONE_BRICKS("cracked_polished_blackstone_bricks", Block::BlockSetting());
    const Block CRACKED_STONE_BRICKS("cracked_stone_bricks", Block::BlockSetting());
    const Block CRAFTER("crafter", Block::BlockSetting());
    const Block CRAFTING_TABLE("crafting_table", Block::BlockSetting());
    const Block CREAKING_HEART("creaking_heart", Block::BlockSetting());
    const Block CREEPER_HEAD("creeper_head", Block::BlockSetting());
    const Block CREEPER_WALL_HEAD("creeper_wall_head", Block::BlockSetting());
    const Block CRIMSON_BUTTON("crimson_button", Block::BlockSetting());
    const Block CRIMSON_DOOR("crimson_door", Block::BlockSetting());
    const Block CRIMSON_FENCE("crimson_fence", Block::BlockSetting());
    const Block CRIMSON_FENCE_GATE("crimson_fence_gate", Block::BlockSetting());
    const Block CRIMSON_FUNGUS("crimson_fungus", Block::BlockSetting());
    const Block CRIMSON_HANGING_SIGN("crimson_hanging_sign", Block::BlockSetting());
    const Block CRIMSON_HYPHAE("crimson_hyphae", Block::BlockSetting());
    const Block CRIMSON_NYLIUM("crimson_nylium", Block::BlockSetting());
    const Block CRIMSON_PLANKS("crimson_planks", Block::BlockSetting());
    const Block CRIMSON_PRESSURE_PLATE("crimson_pressure_plate", Block::BlockSetting());
    const Block CRIMSON_ROOTS("crimson_roots", Block::BlockSetting());
    const Block CRIMSON_SIGN("crimson_sign", Block::BlockSetting());
    const Block CRIMSON_SLAB("crimson_slab", Block::BlockSetting());
    const Block CRIMSON_STAIRS("crimson_stairs", Block::BlockSetting());
    const Block CRIMSON_STEM("crimson_stem", Block::BlockSetting());
    const Block CRIMSON_TRAPDOOR("crimson_trapdoor", Block::BlockSetting());
    const Block CRIMSON_WALL_HANGING_SIGN("crimson_wall_hanging_sign", Block::BlockSetting());
    const Block CRIMSON_WALL_SIGN("crimson_wall_sign", Block::BlockSetting());
    const Block CRYING_OBSIDIAN("crying_obsidian", Block::BlockSetting());
    const Block CUT_COPPER("cut_copper", Block::BlockSetting());
    const Block CUT_COPPER_SLAB("cut_copper_slab", Block::BlockSetting());
    const Block CUT_COPPER_STAIRS("cut_copper_stairs", Block::BlockSetting());
    const Block CUT_RED_SANDSTONE("cut_red_sandstone", Block::BlockSetting());
    const Block CUT_RED_SANDSTONE_SLAB("cut_red_sandstone_slab", Block::BlockSetting());
    const Block CUT_SANDSTONE("cut_sandstone", Block::BlockSetting());
    const Block CUT_SANDSTONE_SLAB("cut_sandstone_slab", Block::BlockSetting());
    const Block CYAN_BANNER("cyan_banner", Block::BlockSetting());
    const Block CYAN_BED("cyan_bed", Block::BlockSetting());
    const Block CYAN_CANDLE("cyan_candle", Block::BlockSetting());
    const Block CYAN_CANDLE_CAKE("cyan_candle_cake", Block::BlockSetting());
    const Block CYAN_CARPET("cyan_carpet", Block::BlockSetting());
    const Block CYAN_CONCRETE("cyan_concrete", Block::BlockSetting());
    const Block CYAN_CONCRETE_POWDER("cyan_concrete_powder", Block::BlockSetting());
    const Block CYAN_GLAZED_TERRACOTTA("cyan_glazed_terracotta", Block::BlockSetting());
    const Block CYAN_SHULKER_BOX("cyan_shulker_box", Block::BlockSetting());
    const Block CYAN_STAINED_GLASS("cyan_stained_glass", Block::BlockSetting());
    const Block CYAN_STAINED_GLASS_PANE("cyan_stained_glass_pane", Block::BlockSetting());
    const Block CYAN_TERRACOTTA("cyan_terracotta", Block::BlockSetting());
    const Block CYAN_WALL_BANNER("cyan_wall_banner", Block::BlockSetting());
    const Block CYAN_WOOL("cyan_wool", Block::BlockSetting());
    const Block DAMAGED_ANVIL("damaged_anvil", Block::BlockSetting());
    const Block DANDELION("dandelion", Block::BlockSetting());
    const Block DARK_OAK_BUTTON("dark_oak_button", Block::BlockSetting());
    const Block DARK_OAK_DOOR("dark_oak_door", Block::BlockSetting());
    const Block DARK_OAK_FENCE("dark_oak_fence", Block::BlockSetting());
    const Block DARK_OAK_FENCE_GATE("dark_oak_fence_gate", Block::BlockSetting());
    const Block DARK_OAK_HANGING_SIGN("dark_oak_hanging_sign", Block::BlockSetting());
    const Block DARK_OAK_LEAVES("dark_oak_leaves", Block::BlockSetting());
    const Block DARK_OAK_LOG("dark_oak_log", Block::BlockSetting());
    const Block DARK_OAK_PLANKS("dark_oak_planks", Block::BlockSetting());
    const Block DARK_OAK_PRESSURE_PLATE("dark_oak_pressure_plate", Block::BlockSetting());
    const Block DARK_OAK_SAPLING("dark_oak_sapling", Block::BlockSetting());
    const Block DARK_OAK_SIGN("dark_oak_sign", Block::BlockSetting());
    const Block DARK_OAK_SLAB("dark_oak_slab", Block::BlockSetting());
    const Block DARK_OAK_STAIRS("dark_oak_stairs", Block::BlockSetting());
    const Block DARK_OAK_TRAPDOOR("dark_oak_trapdoor", Block::BlockSetting());
    const Block DARK_OAK_WALL_HANGING_SIGN("dark_oak_wall_hanging_sign", Block::BlockSetting());
    const Block DARK_OAK_WALL_SIGN("dark_oak_wall_sign", Block::BlockSetting());
    const Block DARK_OAK_WOOD("dark_oak_wood", Block::BlockSetting());
    const Block DARK_PRISMARINE("dark_prismarine", Block::BlockSetting());
    const Block DARK_PRISMARINE_SLAB("dark_prismarine_slab", Block::BlockSetting());
    const Block DARK_PRISMARINE_STAIRS("dark_prismarine_stairs", Block::BlockSetting());
    const Block DAYLIGHT_DETECTOR("daylight_detector", Block::BlockSetting());
    const Block DEAD_BRAIN_CORAL("dead_brain_coral", Block::BlockSetting());
    const Block DEAD_BRAIN_CORAL_BLOCK("dead_brain_coral_block", Block::BlockSetting());
    const Block DEAD_BRAIN_CORAL_FAN("dead_brain_coral_fan", Block::BlockSetting());
    const Block DEAD_BRAIN_CORAL_WALL_FAN("dead_brain_coral_wall_fan", Block::BlockSetting());
    const Block DEAD_BUBBLE_CORAL("dead_bubble_coral", Block::BlockSetting());
    const Block DEAD_BUBBLE_CORAL_BLOCK("dead_bubble_coral_block", Block::BlockSetting());
    const Block DEAD_BUBBLE_CORAL_FAN("dead_bubble_coral_fan", Block::BlockSetting());
    const Block DEAD_BUBBLE_CORAL_WALL_FAN("dead_bubble_coral_wall_fan", Block::BlockSetting());
    const Block DEAD_BUSH("dead_bush", Block::BlockSetting());
    const Block DEAD_FIRE_CORAL("dead_fire_coral", Block::BlockSetting());
    const Block DEAD_FIRE_CORAL_BLOCK("dead_fire_coral_block", Block::BlockSetting());
    const Block DEAD_FIRE_CORAL_FAN("dead_fire_coral_fan", Block::BlockSetting());
    const Block DEAD_FIRE_CORAL_WALL_FAN("dead_fire_coral_wall_fan", Block::BlockSetting());
    const Block DEAD_HORN_CORAL("dead_horn_coral", Block::BlockSetting());
    const Block DEAD_HORN_CORAL_BLOCK("dead_horn_coral_block", Block::BlockSetting());
    const Block DEAD_HORN_CORAL_FAN("dead_horn_coral_fan", Block::BlockSetting());
    const Block DEAD_HORN_CORAL_WALL_FAN("dead_horn_coral_wall_fan", Block::BlockSetting());
    const Block DEAD_TUBE_CORAL("dead_tube_coral", Block::BlockSetting());
    const Block DEAD_TUBE_CORAL_BLOCK("dead_tube_coral_block", Block::BlockSetting());
    const Block DEAD_TUBE_CORAL_FAN("dead_tube_coral_fan", Block::BlockSetting());
    const Block DEAD_TUBE_CORAL_WALL_FAN("dead_tube_coral_wall_fan", Block::BlockSetting());
    const Block DECORATED_POT("decorated_pot", Block::BlockSetting());
    const Block DEEPSLATE("deepslate", Block::BlockSetting());
    const Block DEEPSLATE_BRICK_SLAB("deepslate_brick_slab", Block::BlockSetting());
    const Block DEEPSLATE_BRICK_STAIRS("deepslate_brick_stairs", Block::BlockSetting());
    const Block DEEPSLATE_BRICK_WALL("deepslate_brick_wall", Block::BlockSetting());
    const Block DEEPSLATE_BRICKS("deepslate_bricks", Block::BlockSetting());
    const Block DEEPSLATE_COAL_ORE("deepslate_coal_ore", Block::BlockSetting());
    const Block DEEPSLATE_COPPER_ORE("deepslate_copper_ore", Block::BlockSetting());
    const Block DEEPSLATE_DIAMOND_ORE("deepslate_diamond_ore", Block::BlockSetting());
    const Block DEEPSLATE_EMERALD_ORE("deepslate_emerald_ore", Block::BlockSetting());
    const Block DEEPSLATE_GOLD_ORE("deepslate_gold_ore", Block::BlockSetting());
    const Block DEEPSLATE_IRON_ORE("deepslate_iron_ore", Block::BlockSetting());
    const Block DEEPSLATE_LAPIS_ORE("deepslate_lapis_ore", Block::BlockSetting());
    const Block DEEPSLATE_REDSTONE_ORE("deepslate_redstone_ore", Block::BlockSetting());
    const Block DEEPSLATE_TILE_SLAB("deepslate_tile_slab", Block::BlockSetting());
    const Block DEEPSLATE_TILE_STAIRS("deepslate_tile_stairs", Block::BlockSetting());
    const Block DEEPSLATE_TILE_WALL("deepslate_tile_wall", Block::BlockSetting());
    const Block DEEPSLATE_TILES("deepslate_tiles", Block::BlockSetting());
    const Block DETECTOR_RAIL("detector_rail", Block::BlockSetting());
    const Block DIAMOND_BLOCK("diamond_block", Block::BlockSetting());
    const Block DIAMOND_ORE("diamond_ore", Block::BlockSetting());
    const Block DIORITE("diorite", Block::BlockSetting());
    const Block DIORITE_SLAB("diorite_slab", Block::BlockSetting());
    const Block DIORITE_STAIRS("diorite_stairs", Block::BlockSetting());
    const Block DIORITE_WALL("diorite_wall", Block::BlockSetting());
    const Block DIRT("dirt", Block::BlockSetting());
    const Block DIRT_PATH("dirt_path", Block::BlockSetting());
    const Block DISPENSER("dispenser", Block::BlockSetting());
    const Block DRAGON_EGG("dragon_egg", Block::BlockSetting());
    const Block DRAGON_HEAD("dragon_head", Block::BlockSetting());
    const Block DRAGON_WALL_HEAD("dragon_wall_head", Block::BlockSetting());
    const Block DRIED_KELP_BLOCK("dried_kelp_block", Block::BlockSetting());
    const Block DRIPSTONE_BLOCK("dripstone_block", Block::BlockSetting());
    const Block DROPPER("dropper", Block::BlockSetting());
    const Block EMERALD_BLOCK("emerald_block", Block::BlockSetting());
    const Block EMERALD_ORE("emerald_ore", Block::BlockSetting());
    const Block ENCHANTING_TABLE("enchanting_table", Block::BlockSetting());
    const Block END_GATEWAY("end_gateway", Block::BlockSetting());
    const Block END_PORTAL("end_portal", Block::BlockSetting());
    const Block END_PORTAL_FRAME("end_portal_frame", Block::BlockSetting());
    const Block END_ROD("end_rod", Block::BlockSetting());
    const Block END_STONE("end_stone", Block::BlockSetting());
    const Block END_STONE_BRICK_SLAB("end_stone_brick_slab", Block::BlockSetting());
    const Block END_STONE_BRICK_STAIRS("end_stone_brick_stairs", Block::BlockSetting());
    const Block END_STONE_BRICK_WALL("end_stone_brick_wall", Block::BlockSetting());
    const Block END_STONE_BRICKS("end_stone_bricks", Block::BlockSetting());
    const Block ENDER_CHEST("ender_chest", Block::BlockSetting());
    const Block EXPOSED_CHISELED_COPPER("exposed_chiseled_copper", Block::BlockSetting());
    const Block EXPOSED_COPPER("exposed_copper", Block::BlockSetting());
    const Block EXPOSED_COPPER_BULB("exposed_copper_bulb", Block::BlockSetting());
    const Block EXPOSED_COPPER_DOOR("exposed_copper_door", Block::BlockSetting());
    const Block EXPOSED_COPPER_GRATE("exposed_copper_grate", Block::BlockSetting());
    const Block EXPOSED_COPPER_TRAPDOOR("exposed_copper_trapdoor", Block::BlockSetting());
    const Block EXPOSED_CUT_COPPER("exposed_cut_copper", Block::BlockSetting());
    const Block EXPOSED_CUT_COPPER_SLAB("exposed_cut_copper_slab", Block::BlockSetting());
    const Block EXPOSED_CUT_COPPER_STAIRS("exposed_cut_copper_stairs", Block::BlockSetting());
    const Block FARMLAND("farmland", Block::BlockSetting());
    const Block FERN("fern", Block::BlockSetting());
    const Block FIRE("fire", Block::BlockSetting());
    const Block FIRE_CORAL("fire_coral", Block::BlockSetting());
    const Block FIRE_CORAL_BLOCK("fire_coral_block", Block::BlockSetting());
    const Block FIRE_CORAL_FAN("fire_coral_fan", Block::BlockSetting());
    const Block FIRE_CORAL_WALL_FAN("fire_coral_wall_fan", Block::BlockSetting());
    const Block FIREFLY_BUSH("firefly_bush", Block::BlockSetting());
    const Block FLETCHING_TABLE("fletching_table", Block::BlockSetting());
    const Block FLOWER_POT("flower_pot", Block::BlockSetting());
    const Block FLOWERING_AZALEA("flowering_azalea", Block::BlockSetting());
    const Block FLOWERING_AZALEA_LEAVES("flowering_azalea_leaves", Block::BlockSetting());
    const Block FROGSPAWN("frogspawn", Block::BlockSetting());
    const Block FROSTED_ICE("frosted_ice", Block::BlockSetting());
    const Block FURNACE("furnace", Block::BlockSetting());
    const Block GILDED_BLACKSTONE("gilded_blackstone", Block::BlockSetting());
    const Block GLASS("glass", Block::BlockSetting());
    const Block GLASS_PANE("glass_pane", Block::BlockSetting());
    const Block GLOW_LICHEN("glow_lichen", Block::BlockSetting());
    const Block GLOWSTONE("glowstone", Block::BlockSetting());
    const Block GOLD_BLOCK("gold_block", Block::BlockSetting());
    const Block GOLD_ORE("gold_ore", Block::BlockSetting());
    const Block GRANITE("granite", Block::BlockSetting());
    const Block GRANITE_SLAB("granite_slab", Block::BlockSetting());
    const Block GRANITE_STAIRS("granite_stairs", Block::BlockSetting());
    const Block GRANITE_WALL("granite_wall", Block::BlockSetting());
    const Block GRASS_BLOCK("grass_block", Block::BlockSetting());
    const Block GRAVEL("gravel", Block::BlockSetting());
    const Block GRAY_BANNER("gray_banner", Block::BlockSetting());
    const Block GRAY_BED("gray_bed", Block::BlockSetting());
    const Block GRAY_CANDLE("gray_candle", Block::BlockSetting());
    const Block GRAY_CANDLE_CAKE("gray_candle_cake", Block::BlockSetting());
    const Block GRAY_CARPET("gray_carpet", Block::BlockSetting());
    const Block GRAY_CONCRETE("gray_concrete", Block::BlockSetting());
    const Block GRAY_CONCRETE_POWDER("gray_concrete_powder", Block::BlockSetting());
    const Block GRAY_GLAZED_TERRACOTTA("gray_glazed_terracotta", Block::BlockSetting());
    const Block GRAY_SHULKER_BOX("gray_shulker_box", Block::BlockSetting());
    const Block GRAY_STAINED_GLASS("gray_stained_glass", Block::BlockSetting());
    const Block GRAY_STAINED_GLASS_PANE("gray_stained_glass_pane", Block::BlockSetting());
    const Block GRAY_TERRACOTTA("gray_terracotta", Block::BlockSetting());
    const Block GRAY_WALL_BANNER("gray_wall_banner", Block::BlockSetting());
    const Block GRAY_WOOL("gray_wool", Block::BlockSetting());
    const Block GREEN_BANNER("green_banner", Block::BlockSetting());
    const Block GREEN_BED("green_bed", Block::BlockSetting());
    const Block GREEN_CANDLE("green_candle", Block::BlockSetting());
    const Block GREEN_CANDLE_CAKE("green_candle_cake", Block::BlockSetting());
    const Block GREEN_CARPET("green_carpet", Block::BlockSetting());
    const Block GREEN_CONCRETE("green_concrete", Block::BlockSetting());
    const Block GREEN_CONCRETE_POWDER("green_concrete_powder", Block::BlockSetting());
    const Block GREEN_GLAZED_TERRACOTTA("green_glazed_terracotta", Block::BlockSetting());
    const Block GREEN_SHULKER_BOX("green_shulker_box", Block::BlockSetting());
    const Block GREEN_STAINED_GLASS("green_stained_glass", Block::BlockSetting());
    const Block GREEN_STAINED_GLASS_PANE("green_stained_glass_pane", Block::BlockSetting());
    const Block GREEN_TERRACOTTA("green_terracotta", Block::BlockSetting());
    const Block GREEN_WALL_BANNER("green_wall_banner", Block::BlockSetting());
    const Block GREEN_WOOL("green_wool", Block::BlockSetting());
    const Block GRINDSTONE("grindstone", Block::BlockSetting());
    const Block HANGING_ROOTS("hanging_roots", Block::BlockSetting());
    const Block HAY_BLOCK("hay_block", Block::BlockSetting());
    const Block HEAVY_CORE("heavy_core", Block::BlockSetting());
    const Block HEAVY_WEIGHTED_PRESSURE_PLATE("heavy_weighted_pressure_plate", Block::BlockSetting());
    const Block HONEY_BLOCK("honey_block", Block::BlockSetting());
    const Block HONEYCOMB_BLOCK("honeycomb_block", Block::BlockSetting());
    const Block HOPPER("hopper", Block::BlockSetting());
    const Block HORN_CORAL("horn_coral", Block::BlockSetting());
    const Block HORN_CORAL_BLOCK("horn_coral_block", Block::BlockSetting());
    const Block HORN_CORAL_FAN("horn_coral_fan", Block::BlockSetting());
    const Block HORN_CORAL_WALL_FAN("horn_coral_wall_fan", Block::BlockSetting());
    const Block ICE("ice", Block::BlockSetting());
    const Block INFESTED_CHISELED_STONE_BRICKS("infested_chiseled_stone_bricks", Block::BlockSetting());
    const Block INFESTED_COBBLESTONE("infested_cobblestone", Block::BlockSetting());
    const Block INFESTED_CRACKED_STONE_BRICKS("infested_cracked_stone_bricks", Block::BlockSetting());
    const Block INFESTED_DEEPSLATE("infested_deepslate", Block::BlockSetting());
    const Block INFESTED_MOSSY_STONE_BRICKS("infested_mossy_stone_bricks", Block::BlockSetting());
    const Block INFESTED_STONE("infested_stone", Block::BlockSetting());
    const Block INFESTED_STONE_BRICKS("infested_stone_bricks", Block::BlockSetting());
    const Block IRON_BARS("iron_bars", Block::BlockSetting());
    const Block IRON_BLOCK("iron_block", Block::BlockSetting());
    const Block IRON_DOOR("iron_door", Block::BlockSetting());
    const Block IRON_ORE("iron_ore", Block::BlockSetting());
    const Block IRON_TRAPDOOR("iron_trapdoor", Block::BlockSetting());
    const Block JACK_O_LANTERN("jack_o_lantern", Block::BlockSetting());
    const Block JIGSAW("jigsaw", Block::BlockSetting());
    const Block JUKEBOX("jukebox", Block::BlockSetting());
    const Block JUNGLE_BUTTON("jungle_button", Block::BlockSetting());
    const Block JUNGLE_DOOR("jungle_door", Block::BlockSetting());
    const Block JUNGLE_FENCE("jungle_fence", Block::BlockSetting());
    const Block JUNGLE_FENCE_GATE("jungle_fence_gate", Block::BlockSetting());
    const Block JUNGLE_HANGING_SIGN("jungle_hanging_sign", Block::BlockSetting());
    const Block JUNGLE_LEAVES("jungle_leaves", Block::BlockSetting());
    const Block JUNGLE_LOG("jungle_log", Block::BlockSetting());
    const Block JUNGLE_PLANKS("jungle_planks", Block::BlockSetting());
    const Block JUNGLE_PRESSURE_PLATE("jungle_pressure_plate", Block::BlockSetting());
    const Block JUNGLE_SAPLING("jungle_sapling", Block::BlockSetting());
    const Block JUNGLE_SIGN("jungle_sign", Block::BlockSetting());
    const Block JUNGLE_SLAB("jungle_slab", Block::BlockSetting());
    const Block JUNGLE_STAIRS("jungle_stairs", Block::BlockSetting());
    const Block JUNGLE_TRAPDOOR("jungle_trapdoor", Block::BlockSetting());
    const Block JUNGLE_WALL_HANGING_SIGN("jungle_wall_hanging_sign", Block::BlockSetting());
    const Block JUNGLE_WALL_SIGN("jungle_wall_sign", Block::BlockSetting());
    const Block JUNGLE_WOOD("jungle_wood", Block::BlockSetting());
    const Block KELP("kelp", Block::BlockSetting());
    const Block KELP_PLANT("kelp_plant", Block::BlockSetting());
    const Block LADDER("ladder", Block::BlockSetting());
    const Block LANTERN("lantern", Block::BlockSetting());
    const Block LAPIS_BLOCK("lapis_block", Block::BlockSetting());
    const Block LAPIS_ORE("lapis_ore", Block::BlockSetting());
    const Block LARGE_AMETHYST_BUD("large_amethyst_bud", Block::BlockSetting());
    const Block LARGE_FERN("large_fern", Block::BlockSetting());
    const Block LAVA("lava", Block::BlockSetting());
    const Block LAVA_CAULDRON("lava_cauldron", Block::BlockSetting());
    const Block LEAF_LITTER("leaf_litter", Block::BlockSetting());
    const Block LECTERN("lectern", Block::BlockSetting());
    const Block LEVER("lever", Block::BlockSetting());
    const Block LIGHT("light", Block::BlockSetting());
    const Block LIGHT_BLUE_BANNER("light_blue_banner", Block::BlockSetting());
    const Block LIGHT_BLUE_BED("light_blue_bed", Block::BlockSetting());
    const Block LIGHT_BLUE_CANDLE("light_blue_candle", Block::BlockSetting());
    const Block LIGHT_BLUE_CANDLE_CAKE("light_blue_candle_cake", Block::BlockSetting());
    const Block LIGHT_BLUE_CARPET("light_blue_carpet", Block::BlockSetting());
    const Block LIGHT_BLUE_CONCRETE("light_blue_concrete", Block::BlockSetting());
    const Block LIGHT_BLUE_CONCRETE_POWDER("light_blue_concrete_powder", Block::BlockSetting());
    const Block LIGHT_BLUE_GLAZED_TERRACOTTA("light_blue_glazed_terracotta", Block::BlockSetting());
    const Block LIGHT_BLUE_SHULKER_BOX("light_blue_shulker_box", Block::BlockSetting());
    const Block LIGHT_BLUE_STAINED_GLASS("light_blue_stained_glass", Block::BlockSetting());
    const Block LIGHT_BLUE_STAINED_GLASS_PANE("light_blue_stained_glass_pane", Block::BlockSetting());
    const Block LIGHT_BLUE_TERRACOTTA("light_blue_terracotta", Block::BlockSetting());
    const Block LIGHT_BLUE_WALL_BANNER("light_blue_wall_banner", Block::BlockSetting());
    const Block LIGHT_BLUE_WOOL("light_blue_wool", Block::BlockSetting());
    const Block LIGHT_GRAY_BANNER("light_gray_banner", Block::BlockSetting());
    const Block LIGHT_GRAY_BED("light_gray_bed", Block::BlockSetting());
    const Block LIGHT_GRAY_CANDLE("light_gray_candle", Block::BlockSetting());
    const Block LIGHT_GRAY_CANDLE_CAKE("light_gray_candle_cake", Block::BlockSetting());
    const Block LIGHT_GRAY_CARPET("light_gray_carpet", Block::BlockSetting());
    const Block LIGHT_GRAY_CONCRETE("light_gray_concrete", Block::BlockSetting());
    const Block LIGHT_GRAY_CONCRETE_POWDER("light_gray_concrete_powder", Block::BlockSetting());
    const Block LIGHT_GRAY_GLAZED_TERRACOTTA("light_gray_glazed_terracotta", Block::BlockSetting());
    const Block LIGHT_GRAY_SHULKER_BOX("light_gray_shulker_box", Block::BlockSetting());
    const Block LIGHT_GRAY_STAINED_GLASS("light_gray_stained_glass", Block::BlockSetting());
    const Block LIGHT_GRAY_STAINED_GLASS_PANE("light_gray_stained_glass_pane", Block::BlockSetting());
    const Block LIGHT_GRAY_TERRACOTTA("light_gray_terracotta", Block::BlockSetting());
    const Block LIGHT_GRAY_WALL_BANNER("light_gray_wall_banner", Block::BlockSetting());
    const Block LIGHT_GRAY_WOOL("light_gray_wool", Block::BlockSetting());
    const Block LIGHT_WEIGHTED_PRESSURE_PLATE("light_weighted_pressure_plate", Block::BlockSetting());
    const Block LIGHTNING_ROD("lightning_rod", Block::BlockSetting());
    const Block LILAC("lilac", Block::BlockSetting());
    const Block LILY_OF_THE_VALLEY("lily_of_the_valley", Block::BlockSetting());
    const Block LILY_PAD("lily_pad", Block::BlockSetting());
    const Block LIME_BANNER("lime_banner", Block::BlockSetting());
    const Block LIME_BED("lime_bed", Block::BlockSetting());
    const Block LIME_CANDLE("lime_candle", Block::BlockSetting());
    const Block LIME_CANDLE_CAKE("lime_candle_cake", Block::BlockSetting());
    const Block LIME_CARPET("lime_carpet", Block::BlockSetting());
    const Block LIME_CONCRETE("lime_concrete", Block::BlockSetting());
    const Block LIME_CONCRETE_POWDER("lime_concrete_powder", Block::BlockSetting());
    const Block LIME_GLAZED_TERRACOTTA("lime_glazed_terracotta", Block::BlockSetting());
    const Block LIME_SHULKER_BOX("lime_shulker_box", Block::BlockSetting());
    const Block LIME_STAINED_GLASS("lime_stained_glass", Block::BlockSetting());
    const Block LIME_STAINED_GLASS_PANE("lime_stained_glass_pane", Block::BlockSetting());
    const Block LIME_TERRACOTTA("lime_terracotta", Block::BlockSetting());
    const Block LIME_WALL_BANNER("lime_wall_banner", Block::BlockSetting());
    const Block LIME_WOOL("lime_wool", Block::BlockSetting());
    const Block LODESTONE("lodestone", Block::BlockSetting());
    const Block LOOM("loom", Block::BlockSetting());
    const Block MAGENTA_BANNER("magenta_banner", Block::BlockSetting());
    const Block MAGENTA_BED("magenta_bed", Block::BlockSetting());
    const Block MAGENTA_CANDLE("magenta_candle", Block::BlockSetting());
    const Block MAGENTA_CANDLE_CAKE("magenta_candle_cake", Block::BlockSetting());
    const Block MAGENTA_CARPET("magenta_carpet", Block::BlockSetting());
    const Block MAGENTA_CONCRETE("magenta_concrete", Block::BlockSetting());
    const Block MAGENTA_CONCRETE_POWDER("magenta_concrete_powder", Block::BlockSetting());
    const Block MAGENTA_GLAZED_TERRACOTTA("magenta_glazed_terracotta", Block::BlockSetting());
    const Block MAGENTA_SHULKER_BOX("magenta_shulker_box", Block::BlockSetting());
    const Block MAGENTA_STAINED_GLASS("magenta_stained_glass", Block::BlockSetting());
    const Block MAGENTA_STAINED_GLASS_PANE("magenta_stained_glass_pane", Block::BlockSetting());
    const Block MAGENTA_TERRACOTTA("magenta_terracotta", Block::BlockSetting());
    const Block MAGENTA_WALL_BANNER("magenta_wall_banner", Block::BlockSetting());
    const Block MAGENTA_WOOL("magenta_wool", Block::BlockSetting());
    const Block MAGMA_BLOCK("magma_block", Block::BlockSetting());
    const Block MANGROVE_BUTTON("mangrove_button", Block::BlockSetting());
    const Block MANGROVE_DOOR("mangrove_door", Block::BlockSetting());
    const Block MANGROVE_FENCE("mangrove_fence", Block::BlockSetting());
    const Block MANGROVE_FENCE_GATE("mangrove_fence_gate", Block::BlockSetting());
    const Block MANGROVE_HANGING_SIGN("mangrove_hanging_sign", Block::BlockSetting());
    const Block MANGROVE_LEAVES("mangrove_leaves", Block::BlockSetting());
    const Block MANGROVE_LOG("mangrove_log", Block::BlockSetting());
    const Block MANGROVE_PLANKS("mangrove_planks", Block::BlockSetting());
    const Block MANGROVE_PRESSURE_PLATE("mangrove_pressure_plate", Block::BlockSetting());
    const Block MANGROVE_PROPAGULE("mangrove_propagule", Block::BlockSetting());
    const Block MANGROVE_ROOTS("mangrove_roots", Block::BlockSetting());
    const Block MANGROVE_SIGN("mangrove_sign", Block::BlockSetting());
    const Block MANGROVE_SLAB("mangrove_slab", Block::BlockSetting());
    const Block MANGROVE_STAIRS("mangrove_stairs", Block::BlockSetting());
    const Block MANGROVE_TRAPDOOR("mangrove_trapdoor", Block::BlockSetting());
    const Block MANGROVE_WALL_HANGING_SIGN("mangrove_wall_hanging_sign", Block::BlockSetting());
    const Block MANGROVE_WALL_SIGN("mangrove_wall_sign", Block::BlockSetting());
    const Block MANGROVE_WOOD("mangrove_wood", Block::BlockSetting());
    const Block MEDIUM_AMETHYST_BUD("medium_amethyst_bud", Block::BlockSetting());
    const Block MELON("melon", Block::BlockSetting());
    const Block MELON_STEM("melon_stem", Block::BlockSetting());
    const Block MOSS_BLOCK("moss_block", Block::BlockSetting());
    const Block MOSS_CARPET("moss_carpet", Block::BlockSetting());
    const Block MOSSY_COBBLESTONE("mossy_cobblestone", Block::BlockSetting());
    const Block MOSSY_COBBLESTONE_SLAB("mossy_cobblestone_slab", Block::BlockSetting());
    const Block MOSSY_COBBLESTONE_STAIRS("mossy_cobblestone_stairs", Block::BlockSetting());
    const Block MOSSY_COBBLESTONE_WALL("mossy_cobblestone_wall", Block::BlockSetting());
    const Block MOSSY_STONE_BRICK_SLAB("mossy_stone_brick_slab", Block::BlockSetting());
    const Block MOSSY_STONE_BRICK_STAIRS("mossy_stone_brick_stairs", Block::BlockSetting());
    const Block MOSSY_STONE_BRICK_WALL("mossy_stone_brick_wall", Block::BlockSetting());
    const Block MOSSY_STONE_BRICKS("mossy_stone_bricks", Block::BlockSetting());
    const Block MOVING_PISTON("moving_piston", Block::BlockSetting());
    const Block MUD("mud", Block::BlockSetting());
    const Block MUD_BRICK_SLAB("mud_brick_slab", Block::BlockSetting());
    const Block MUD_BRICK_STAIRS("mud_brick_stairs", Block::BlockSetting());
    const Block MUD_BRICK_WALL("mud_brick_wall", Block::BlockSetting());
    const Block MUD_BRICKS("mud_bricks", Block::BlockSetting());
    const Block MUDDY_MANGROVE_ROOTS("muddy_mangrove_roots", Block::BlockSetting());
    const Block MUSHROOM_STEM("mushroom_stem", Block::BlockSetting());
    const Block MYCELIUM("mycelium", Block::BlockSetting());
    const Block NETHER_BRICK_FENCE("nether_brick_fence", Block::BlockSetting());
    const Block NETHER_BRICK_SLAB("nether_brick_slab", Block::BlockSetting());
    const Block NETHER_BRICK_STAIRS("nether_brick_stairs", Block::BlockSetting());
    const Block NETHER_BRICK_WALL("nether_brick_wall", Block::BlockSetting());
    const Block NETHER_BRICKS("nether_bricks", Block::BlockSetting());
    const Block NETHER_GOLD_ORE("nether_gold_ore", Block::BlockSetting());
    const Block NETHER_PORTAL("nether_portal", Block::BlockSetting());
    const Block NETHER_QUARTZ_ORE("nether_quartz_ore", Block::BlockSetting());
    const Block NETHER_SPROUTS("nether_sprouts", Block::BlockSetting());
    const Block NETHER_WART("nether_wart", Block::BlockSetting());
    const Block NETHER_WART_BLOCK("nether_wart_block", Block::BlockSetting());
    const Block NETHERITE_BLOCK("netherite_block", Block::BlockSetting());
    const Block NETHERRACK("netherrack", Block::BlockSetting());
    const Block NOTE_BLOCK("note_block", Block::BlockSetting());
    const Block OAK_BUTTON("oak_button", Block::BlockSetting());
    const Block OAK_DOOR("oak_door", Block::BlockSetting());
    const Block OAK_FENCE("oak_fence", Block::BlockSetting());
    const Block OAK_FENCE_GATE("oak_fence_gate", Block::BlockSetting());
    const Block OAK_HANGING_SIGN("oak_hanging_sign", Block::BlockSetting());
    const Block OAK_LEAVES("oak_leaves", Block::BlockSetting());
    const Block OAK_LOG("oak_log", Block::BlockSetting());
    const Block OAK_PLANKS("oak_planks", Block::BlockSetting());
    const Block OAK_PRESSURE_PLATE("oak_pressure_plate", Block::BlockSetting());
    const Block OAK_SAPLING("oak_sapling", Block::BlockSetting());
    const Block OAK_SIGN("oak_sign", Block::BlockSetting());
    const Block OAK_SLAB("oak_slab", Block::BlockSetting());
    const Block OAK_STAIRS("oak_stairs", Block::BlockSetting());
    const Block OAK_TRAPDOOR("oak_trapdoor", Block::BlockSetting());
    const Block OAK_WALL_HANGING_SIGN("oak_wall_hanging_sign", Block::BlockSetting());
    const Block OAK_WALL_SIGN("oak_wall_sign", Block::BlockSetting());
    const Block OAK_WOOD("oak_wood", Block::BlockSetting());
    const Block OBSERVER("observer", Block::BlockSetting());
    const Block OBSIDIAN("obsidian", Block::BlockSetting());
    const Block OCHRE_FROGLIGHT("ochre_froglight", Block::BlockSetting());
    const Block OPEN_EYEBLOSSOM("open_eyeblossom", Block::BlockSetting());
    const Block ORANGE_BANNER("orange_banner", Block::BlockSetting());
    const Block ORANGE_BED("orange_bed", Block::BlockSetting());
    const Block ORANGE_CANDLE("orange_candle", Block::BlockSetting());
    const Block ORANGE_CANDLE_CAKE("orange_candle_cake", Block::BlockSetting());
    const Block ORANGE_CARPET("orange_carpet", Block::BlockSetting());
    const Block ORANGE_CONCRETE("orange_concrete", Block::BlockSetting());
    const Block ORANGE_CONCRETE_POWDER("orange_concrete_powder", Block::BlockSetting());
    const Block ORANGE_GLAZED_TERRACOTTA("orange_glazed_terracotta", Block::BlockSetting());
    const Block ORANGE_SHULKER_BOX("orange_shulker_box", Block::BlockSetting());
    const Block ORANGE_STAINED_GLASS("orange_stained_glass", Block::BlockSetting());
    const Block ORANGE_STAINED_GLASS_PANE("orange_stained_glass_pane", Block::BlockSetting());
    const Block ORANGE_TERRACOTTA("orange_terracotta", Block::BlockSetting());
    const Block ORANGE_TULIP("orange_tulip", Block::BlockSetting());
    const Block ORANGE_WALL_BANNER("orange_wall_banner", Block::BlockSetting());
    const Block ORANGE_WOOL("orange_wool", Block::BlockSetting());
    const Block OXEYE_DAISY("oxeye_daisy", Block::BlockSetting());
    const Block OXIDIZED_CHISELED_COPPER("oxidized_chiseled_copper", Block::BlockSetting());
    const Block OXIDIZED_COPPER("oxidized_copper", Block::BlockSetting());
    const Block OXIDIZED_COPPER_BULB("oxidized_copper_bulb", Block::BlockSetting());
    const Block OXIDIZED_COPPER_DOOR("oxidized_copper_door", Block::BlockSetting());
    const Block OXIDIZED_COPPER_GRATE("oxidized_copper_grate", Block::BlockSetting());
    const Block OXIDIZED_COPPER_TRAPDOOR("oxidized_copper_trapdoor", Block::BlockSetting());
    const Block OXIDIZED_CUT_COPPER("oxidized_cut_copper", Block::BlockSetting());
    const Block OXIDIZED_CUT_COPPER_SLAB("oxidized_cut_copper_slab", Block::BlockSetting());
    const Block OXIDIZED_CUT_COPPER_STAIRS("oxidized_cut_copper_stairs", Block::BlockSetting());
    const Block PACKED_ICE("packed_ice", Block::BlockSetting());
    const Block PACKED_MUD("packed_mud", Block::BlockSetting());
    const Block PALE_HANGING_MOSS("pale_hanging_moss", Block::BlockSetting());
    const Block PALE_MOSS_BLOCK("pale_moss_block", Block::BlockSetting());
    const Block PALE_MOSS_CARPET("pale_moss_carpet", Block::BlockSetting());
    const Block PALE_OAK_BUTTON("pale_oak_button", Block::BlockSetting());
    const Block PALE_OAK_DOOR("pale_oak_door", Block::BlockSetting());
    const Block PALE_OAK_FENCE("pale_oak_fence", Block::BlockSetting());
    const Block PALE_OAK_FENCE_GATE("pale_oak_fence_gate", Block::BlockSetting());
    const Block PALE_OAK_HANGING_SIGN("pale_oak_hanging_sign", Block::BlockSetting());
    const Block PALE_OAK_LEAVES("pale_oak_leaves", Block::BlockSetting());
    const Block PALE_OAK_LOG("pale_oak_log", Block::BlockSetting());
    const Block PALE_OAK_PLANKS("pale_oak_planks", Block::BlockSetting());
    const Block PALE_OAK_PRESSURE_PLATE("pale_oak_pressure_plate", Block::BlockSetting());
    const Block PALE_OAK_SAPLING("pale_oak_sapling", Block::BlockSetting());
    const Block PALE_OAK_SIGN("pale_oak_sign", Block::BlockSetting());
    const Block PALE_OAK_SLAB("pale_oak_slab", Block::BlockSetting());
    const Block PALE_OAK_STAIRS("pale_oak_stairs", Block::BlockSetting());
    const Block PALE_OAK_TRAPDOOR("pale_oak_trapdoor", Block::BlockSetting());
    const Block PALE_OAK_WALL_HANGING_SIGN("pale_oak_wall_hanging_sign", Block::BlockSetting());
    const Block PALE_OAK_WALL_SIGN("pale_oak_wall_sign", Block::BlockSetting());
    const Block PALE_OAK_WOOD("pale_oak_wood", Block::BlockSetting());
    const Block PEARLESCENT_FROGLIGHT("pearlescent_froglight", Block::BlockSetting());
    const Block PEONY("peony", Block::BlockSetting());
    const Block PETRIFIED_OAK_SLAB("petrified_oak_slab", Block::BlockSetting());
    const Block PIGLIN_HEAD("piglin_head", Block::BlockSetting());
    const Block PIGLIN_WALL_HEAD("piglin_wall_head", Block::BlockSetting());
    const Block PINK_BANNER("pink_banner", Block::BlockSetting());
    const Block PINK_BED("pink_bed", Block::BlockSetting());
    const Block PINK_CANDLE("pink_candle", Block::BlockSetting());
    const Block PINK_CANDLE_CAKE("pink_candle_cake", Block::BlockSetting());
    const Block PINK_CARPET("pink_carpet", Block::BlockSetting());
    const Block PINK_CONCRETE("pink_concrete", Block::BlockSetting());
    const Block PINK_CONCRETE_POWDER("pink_concrete_powder", Block::BlockSetting());
    const Block PINK_GLAZED_TERRACOTTA("pink_glazed_terracotta", Block::BlockSetting());
    const Block PINK_PETALS("pink_petals", Block::BlockSetting());
    const Block PINK_SHULKER_BOX("pink_shulker_box", Block::BlockSetting());
    const Block PINK_STAINED_GLASS("pink_stained_glass", Block::BlockSetting());
    const Block PINK_STAINED_GLASS_PANE("pink_stained_glass_pane", Block::BlockSetting());
    const Block PINK_TERRACOTTA("pink_terracotta", Block::BlockSetting());
    const Block PINK_TULIP("pink_tulip", Block::BlockSetting());
    const Block PINK_WALL_BANNER("pink_wall_banner", Block::BlockSetting());
    const Block PINK_WOOL("pink_wool", Block::BlockSetting());
    const Block PISTON("piston", Block::BlockSetting());
    const Block PISTON_HEAD("piston_head", Block::BlockSetting());
    const Block PITCHER_CROP("pitcher_crop", Block::BlockSetting());
    const Block PITCHER_PLANT("pitcher_plant", Block::BlockSetting());
    const Block PLAYER_HEAD("player_head", Block::BlockSetting());
    const Block PLAYER_WALL_HEAD("player_wall_head", Block::BlockSetting());
    const Block PODZOL("podzol", Block::BlockSetting());
    const Block POINTED_DRIPSTONE("pointed_dripstone", Block::BlockSetting());
    const Block POLISHED_ANDESITE("polished_andesite", Block::BlockSetting());
    const Block POLISHED_ANDESITE_SLAB("polished_andesite_slab", Block::BlockSetting());
    const Block POLISHED_ANDESITE_STAIRS("polished_andesite_stairs", Block::BlockSetting());
    const Block POLISHED_BASALT("polished_basalt", Block::BlockSetting());
    const Block POLISHED_BLACKSTONE("polished_blackstone", Block::BlockSetting());
    const Block POLISHED_BLACKSTONE_BRICK_SLAB("polished_blackstone_brick_slab", Block::BlockSetting());
    const Block POLISHED_BLACKSTONE_BRICK_STAIRS("polished_blackstone_brick_stairs", Block::BlockSetting());
    const Block POLISHED_BLACKSTONE_BRICK_WALL("polished_blackstone_brick_wall", Block::BlockSetting());
    const Block POLISHED_BLACKSTONE_BRICKS("polished_blackstone_bricks", Block::BlockSetting());
    const Block POLISHED_BLACKSTONE_BUTTON("polished_blackstone_button", Block::BlockSetting());
    const Block POLISHED_BLACKSTONE_PRESSURE_PLATE("polished_blackstone_pressure_plate", Block::BlockSetting());
    const Block POLISHED_BLACKSTONE_SLAB("polished_blackstone_slab", Block::BlockSetting());
    const Block POLISHED_BLACKSTONE_STAIRS("polished_blackstone_stairs", Block::BlockSetting());
    const Block POLISHED_BLACKSTONE_WALL("polished_blackstone_wall", Block::BlockSetting());
    const Block POLISHED_DEEPSLATE("polished_deepslate", Block::BlockSetting());
    const Block POLISHED_DEEPSLATE_SLAB("polished_deepslate_slab", Block::BlockSetting());
    const Block POLISHED_DEEPSLATE_STAIRS("polished_deepslate_stairs", Block::BlockSetting());
    const Block POLISHED_DEEPSLATE_WALL("polished_deepslate_wall", Block::BlockSetting());
    const Block POLISHED_DIORITE("polished_diorite", Block::BlockSetting());
    const Block POLISHED_DIORITE_SLAB("polished_diorite_slab", Block::BlockSetting());
    const Block POLISHED_DIORITE_STAIRS("polished_diorite_stairs", Block::BlockSetting());
    const Block POLISHED_GRANITE("polished_granite", Block::BlockSetting());
    const Block POLISHED_GRANITE_SLAB("polished_granite_slab", Block::BlockSetting());
    const Block POLISHED_GRANITE_STAIRS("polished_granite_stairs", Block::BlockSetting());
    const Block POLISHED_TUFF("polished_tuff", Block::BlockSetting());
    const Block POLISHED_TUFF_SLAB("polished_tuff_slab", Block::BlockSetting());
    const Block POLISHED_TUFF_STAIRS("polished_tuff_stairs", Block::BlockSetting());
    const Block POLISHED_TUFF_WALL("polished_tuff_wall", Block::BlockSetting());
    const Block POPPY("poppy", Block::BlockSetting());
    const Block POTATOES("potatoes", Block::BlockSetting());
    const Block POTTED_ACACIA_SAPLING("potted_acacia_sapling", Block::BlockSetting());
    const Block POTTED_ALLIUM("potted_allium", Block::BlockSetting());
    const Block POTTED_AZALEA_BUSH("potted_azalea_bush", Block::BlockSetting());
    const Block POTTED_AZURE_BLUET("potted_azure_bluet", Block::BlockSetting());
    const Block POTTED_BAMBOO("potted_bamboo", Block::BlockSetting());
    const Block POTTED_BIRCH_SAPLING("potted_birch_sapling", Block::BlockSetting());
    const Block POTTED_BLUE_ORCHID("potted_blue_orchid", Block::BlockSetting());
    const Block POTTED_BROWN_MUSHROOM("potted_brown_mushroom", Block::BlockSetting());
    const Block POTTED_CACTUS("potted_cactus", Block::BlockSetting());
    const Block POTTED_CHERRY_SAPLING("potted_cherry_sapling", Block::BlockSetting());
    const Block POTTED_CLOSED_EYEBLOSSOM("potted_closed_eyeblossom", Block::BlockSetting());
    const Block POTTED_CORNFLOWER("potted_cornflower", Block::BlockSetting());
    const Block POTTED_CRIMSON_FUNGUS("potted_crimson_fungus", Block::BlockSetting());
    const Block POTTED_CRIMSON_ROOTS("potted_crimson_roots", Block::BlockSetting());
    const Block POTTED_DANDELION("potted_dandelion", Block::BlockSetting());
    const Block POTTED_DARK_OAK_SAPLING("potted_dark_oak_sapling", Block::BlockSetting());
    const Block POTTED_DEAD_BUSH("potted_dead_bush", Block::BlockSetting());
    const Block POTTED_FERN("potted_fern", Block::BlockSetting());
    const Block POTTED_FLOWERING_AZALEA_BUSH("potted_flowering_azalea_bush", Block::BlockSetting());
    const Block POTTED_JUNGLE_SAPLING("potted_jungle_sapling", Block::BlockSetting());
    const Block POTTED_LILY_OF_THE_VALLEY("potted_lily_of_the_valley", Block::BlockSetting());
    const Block POTTED_MANGROVE_PROPAGULE("potted_mangrove_propagule", Block::BlockSetting());
    const Block POTTED_OAK_SAPLING("potted_oak_sapling", Block::BlockSetting());
    const Block POTTED_OPEN_EYEBLOSSOM("potted_open_eyeblossom", Block::BlockSetting());
    const Block POTTED_ORANGE_TULIP("potted_orange_tulip", Block::BlockSetting());
    const Block POTTED_OXEYE_DAISY("potted_oxeye_daisy", Block::BlockSetting());
    const Block POTTED_PALE_OAK_SAPLING("potted_pale_oak_sapling", Block::BlockSetting());
    const Block POTTED_PINK_TULIP("potted_pink_tulip", Block::BlockSetting());
    const Block POTTED_POPPY("potted_poppy", Block::BlockSetting());
    const Block POTTED_RED_MUSHROOM("potted_red_mushroom", Block::BlockSetting());
    const Block POTTED_RED_TULIP("potted_red_tulip", Block::BlockSetting());
    const Block POTTED_SPRUCE_SAPLING("potted_spruce_sapling", Block::BlockSetting());
    const Block POTTED_TORCHFLOWER("potted_torchflower", Block::BlockSetting());
    const Block POTTED_WARPED_FUNGUS("potted_warped_fungus", Block::BlockSetting());
    const Block POTTED_WARPED_ROOTS("potted_warped_roots", Block::BlockSetting());
    const Block POTTED_WHITE_TULIP("potted_white_tulip", Block::BlockSetting());
    const Block POTTED_WITHER_ROSE("potted_wither_rose", Block::BlockSetting());
    const Block POWDER_SNOW("powder_snow", Block::BlockSetting());
    const Block POWDER_SNOW_CAULDRON("powder_snow_cauldron", Block::BlockSetting());
    const Block POWERED_RAIL("powered_rail", Block::BlockSetting());
    const Block PRISMARINE("prismarine", Block::BlockSetting());
    const Block PRISMARINE_BRICK_SLAB("prismarine_brick_slab", Block::BlockSetting());
    const Block PRISMARINE_BRICK_STAIRS("prismarine_brick_stairs", Block::BlockSetting());
    const Block PRISMARINE_BRICKS("prismarine_bricks", Block::BlockSetting());
    const Block PRISMARINE_SLAB("prismarine_slab", Block::BlockSetting());
    const Block PRISMARINE_STAIRS("prismarine_stairs", Block::BlockSetting());
    const Block PRISMARINE_WALL("prismarine_wall", Block::BlockSetting());
    const Block PUMPKIN("pumpkin", Block::BlockSetting());
    const Block PUMPKIN_STEM("pumpkin_stem", Block::BlockSetting());
    const Block PURPLE_BANNER("purple_banner", Block::BlockSetting());
    const Block PURPLE_BED("purple_bed", Block::BlockSetting());
    const Block PURPLE_CANDLE("purple_candle", Block::BlockSetting());
    const Block PURPLE_CANDLE_CAKE("purple_candle_cake", Block::BlockSetting());
    const Block PURPLE_CARPET("purple_carpet", Block::BlockSetting());
    const Block PURPLE_CONCRETE("purple_concrete", Block::BlockSetting());
    const Block PURPLE_CONCRETE_POWDER("purple_concrete_powder", Block::BlockSetting());
    const Block PURPLE_GLAZED_TERRACOTTA("purple_glazed_terracotta", Block::BlockSetting());
    const Block PURPLE_SHULKER_BOX("purple_shulker_box", Block::BlockSetting());
    const Block PURPLE_STAINED_GLASS("purple_stained_glass", Block::BlockSetting());
    const Block PURPLE_STAINED_GLASS_PANE("purple_stained_glass_pane", Block::BlockSetting());
    const Block PURPLE_TERRACOTTA("purple_terracotta", Block::BlockSetting());
    const Block PURPLE_WALL_BANNER("purple_wall_banner", Block::BlockSetting());
    const Block PURPLE_WOOL("purple_wool", Block::BlockSetting());
    const Block PURPUR_BLOCK("purpur_block", Block::BlockSetting());
    const Block PURPUR_PILLAR("purpur_pillar", Block::BlockSetting());
    const Block PURPUR_SLAB("purpur_slab", Block::BlockSetting());
    const Block PURPUR_STAIRS("purpur_stairs", Block::BlockSetting());
    const Block QUARTZ_BLOCK("quartz_block", Block::BlockSetting());
    const Block QUARTZ_BRICKS("quartz_bricks", Block::BlockSetting());
    const Block QUARTZ_PILLAR("quartz_pillar", Block::BlockSetting());
    const Block QUARTZ_SLAB("quartz_slab", Block::BlockSetting());
    const Block QUARTZ_STAIRS("quartz_stairs", Block::BlockSetting());
    const Block RAIL("rail", Block::BlockSetting());
    const Block RAW_COPPER_BLOCK("raw_copper_block", Block::BlockSetting());
    const Block RAW_GOLD_BLOCK("raw_gold_block", Block::BlockSetting());
    const Block RAW_IRON_BLOCK("raw_iron_block", Block::BlockSetting());
    const Block RED_BANNER("red_banner", Block::BlockSetting());
    const Block RED_BED("red_bed", Block::BlockSetting());
    const Block RED_CANDLE("red_candle", Block::BlockSetting());
    const Block RED_CANDLE_CAKE("red_candle_cake", Block::BlockSetting());
    const Block RED_CARPET("red_carpet", Block::BlockSetting());
    const Block RED_CONCRETE("red_concrete", Block::BlockSetting());
    const Block RED_CONCRETE_POWDER("red_concrete_powder", Block::BlockSetting());
    const Block RED_GLAZED_TERRACOTTA("red_glazed_terracotta", Block::BlockSetting());
    const Block RED_MUSHROOM("red_mushroom", Block::BlockSetting());
    const Block RED_MUSHROOM_BLOCK("red_mushroom_block", Block::BlockSetting());
    const Block RED_NETHER_BRICK_SLAB("red_nether_brick_slab", Block::BlockSetting());
    const Block RED_NETHER_BRICK_STAIRS("red_nether_brick_stairs", Block::BlockSetting());
    const Block RED_NETHER_BRICK_WALL("red_nether_brick_wall", Block::BlockSetting());
    const Block RED_NETHER_BRICKS("red_nether_bricks", Block::BlockSetting());
    const Block RED_SAND("red_sand", Block::BlockSetting());
    const Block RED_SANDSTONE("red_sandstone", Block::BlockSetting());
    const Block RED_SANDSTONE_SLAB("red_sandstone_slab", Block::BlockSetting());
    const Block RED_SANDSTONE_STAIRS("red_sandstone_stairs", Block::BlockSetting());
    const Block RED_SANDSTONE_WALL("red_sandstone_wall", Block::BlockSetting());
    const Block RED_SHULKER_BOX("red_shulker_box", Block::BlockSetting());
    const Block RED_STAINED_GLASS("red_stained_glass", Block::BlockSetting());
    const Block RED_STAINED_GLASS_PANE("red_stained_glass_pane", Block::BlockSetting());
    const Block RED_TERRACOTTA("red_terracotta", Block::BlockSetting());
    const Block RED_TULIP("red_tulip", Block::BlockSetting());
    const Block RED_WALL_BANNER("red_wall_banner", Block::BlockSetting());
    const Block RED_WOOL("red_wool", Block::BlockSetting());
    const Block REDSTONE_BLOCK("redstone_block", Block::BlockSetting());
    const Block REDSTONE_LAMP("redstone_lamp", Block::BlockSetting());
    const Block REDSTONE_ORE("redstone_ore", Block::BlockSetting());
    const Block REDSTONE_TORCH("redstone_torch", Block::BlockSetting());
    const Block REDSTONE_WALL_TORCH("redstone_wall_torch", Block::BlockSetting());
    const Block REDSTONE_WIRE("redstone_wire", Block::BlockSetting());
    const Block REINFORCED_DEEPSLATE("reinforced_deepslate", Block::BlockSetting());
    const Block REPEATER("repeater", Block::BlockSetting());
    const Block REPEATING_COMMAND_BLOCK("repeating_command_block", Block::BlockSetting());
    const Block RESIN_BLOCK("resin_block", Block::BlockSetting());
    const Block RESIN_BRICK_SLAB("resin_brick_slab", Block::BlockSetting());
    const Block RESIN_BRICK_STAIRS("resin_brick_stairs", Block::BlockSetting());
    const Block RESIN_BRICK_WALL("resin_brick_wall", Block::BlockSetting());
    const Block RESIN_BRICKS("resin_bricks", Block::BlockSetting());
    const Block RESIN_CLUMP("resin_clump", Block::BlockSetting());
    const Block RESPAWN_ANCHOR("respawn_anchor", Block::BlockSetting());
    const Block ROOTED_DIRT("rooted_dirt", Block::BlockSetting());
    const Block ROSE_BUSH("rose_bush", Block::BlockSetting());
    const Block SAND("sand", Block::BlockSetting());
    const Block SANDSTONE("sandstone", Block::BlockSetting());
    const Block SANDSTONE_SLAB("sandstone_slab", Block::BlockSetting());
    const Block SANDSTONE_STAIRS("sandstone_stairs", Block::BlockSetting());
    const Block SANDSTONE_WALL("sandstone_wall", Block::BlockSetting());
    const Block SCAFFOLDING("scaffolding", Block::BlockSetting());
    const Block SCULK("sculk", Block::BlockSetting());
    const Block SCULK_CATALYST("sculk_catalyst", Block::BlockSetting());
    const Block SCULK_SENSOR("sculk_sensor", Block::BlockSetting());
    const Block SCULK_SHRIEKER("sculk_shrieker", Block::BlockSetting());
    const Block SCULK_VEIN("sculk_vein", Block::BlockSetting());
    const Block SEA_LANTERN("sea_lantern", Block::BlockSetting());
    const Block SEA_PICKLE("sea_pickle", Block::BlockSetting());
    const Block SEAGRASS("seagrass", Block::BlockSetting());
    const Block SHORT_DRY_GRASS("short_dry_grass", Block::BlockSetting());
    const Block SHORT_GRASS("short_grass", Block::BlockSetting());
    const Block SHROOMLIGHT("shroomlight", Block::BlockSetting());
    const Block SHULKER_BOX("shulker_box", Block::BlockSetting());
    const Block SKELETON_SKULL("skeleton_skull", Block::BlockSetting());
    const Block SKELETON_WALL_SKULL("skeleton_wall_skull", Block::BlockSetting());
    const Block SLIME_BLOCK("slime_block", Block::BlockSetting());
    const Block SMALL_AMETHYST_BUD("small_amethyst_bud", Block::BlockSetting());
    const Block SMALL_DRIPLEAF("small_dripleaf", Block::BlockSetting());
    const Block SMITHING_TABLE("smithing_table", Block::BlockSetting());
    const Block SMOKER("smoker", Block::BlockSetting());
    const Block SMOOTH_BASALT("smooth_basalt", Block::BlockSetting());
    const Block SMOOTH_QUARTZ("smooth_quartz", Block::BlockSetting());
    const Block SMOOTH_QUARTZ_SLAB("smooth_quartz_slab", Block::BlockSetting());
    const Block SMOOTH_QUARTZ_STAIRS("smooth_quartz_stairs", Block::BlockSetting());
    const Block SMOOTH_RED_SANDSTONE("smooth_red_sandstone", Block::BlockSetting());
    const Block SMOOTH_RED_SANDSTONE_SLAB("smooth_red_sandstone_slab", Block::BlockSetting());
    const Block SMOOTH_RED_SANDSTONE_STAIRS("smooth_red_sandstone_stairs", Block::BlockSetting());
    const Block SMOOTH_SANDSTONE("smooth_sandstone", Block::BlockSetting());
    const Block SMOOTH_SANDSTONE_SLAB("smooth_sandstone_slab", Block::BlockSetting());
    const Block SMOOTH_SANDSTONE_STAIRS("smooth_sandstone_stairs", Block::BlockSetting());
    const Block SMOOTH_STONE("smooth_stone", Block::BlockSetting());
    const Block SMOOTH_STONE_SLAB("smooth_stone_slab", Block::BlockSetting());
    const Block SNIFFER_EGG("sniffer_egg", Block::BlockSetting());
    const Block SNOW("snow", Block::BlockSetting());
    const Block SNOW_BLOCK("snow_block", Block::BlockSetting());
    const Block SOUL_CAMPFIRE("soul_campfire", Block::BlockSetting());
    const Block SOUL_FIRE("soul_fire", Block::BlockSetting());
    const Block SOUL_LANTERN("soul_lantern", Block::BlockSetting());
    const Block SOUL_SAND("soul_sand", Block::BlockSetting());
    const Block SOUL_SOIL("soul_soil", Block::BlockSetting());
    const Block SOUL_TORCH("soul_torch", Block::BlockSetting());
    const Block SOUL_WALL_TORCH("soul_wall_torch", Block::BlockSetting());
    const Block SPAWNER("spawner", Block::BlockSetting());
    const Block SPONGE("sponge", Block::BlockSetting());
    const Block SPORE_BLOSSOM("spore_blossom", Block::BlockSetting());
    const Block SPRUCE_BUTTON("spruce_button", Block::BlockSetting());
    const Block SPRUCE_DOOR("spruce_door", Block::BlockSetting());
    const Block SPRUCE_FENCE("spruce_fence", Block::BlockSetting());
    const Block SPRUCE_FENCE_GATE("spruce_fence_gate", Block::BlockSetting());
    const Block SPRUCE_HANGING_SIGN("spruce_hanging_sign", Block::BlockSetting());
    const Block SPRUCE_LEAVES("spruce_leaves", Block::BlockSetting());
    const Block SPRUCE_LOG("spruce_log", Block::BlockSetting());
    const Block SPRUCE_PLANKS("spruce_planks", Block::BlockSetting());
    const Block SPRUCE_PRESSURE_PLATE("spruce_pressure_plate", Block::BlockSetting());
    const Block SPRUCE_SAPLING("spruce_sapling", Block::BlockSetting());
    const Block SPRUCE_SIGN("spruce_sign", Block::BlockSetting());
    const Block SPRUCE_SLAB("spruce_slab", Block::BlockSetting());
    const Block SPRUCE_STAIRS("spruce_stairs", Block::BlockSetting());
    const Block SPRUCE_TRAPDOOR("spruce_trapdoor", Block::BlockSetting());
    const Block SPRUCE_WALL_HANGING_SIGN("spruce_wall_hanging_sign", Block::BlockSetting());
    const Block SPRUCE_WALL_SIGN("spruce_wall_sign", Block::BlockSetting());
    const Block SPRUCE_WOOD("spruce_wood", Block::BlockSetting());
    const Block STICKY_PISTON("sticky_piston", Block::BlockSetting());
    const Block STONE("stone", Block::BlockSetting());
    const Block STONE_BRICK_SLAB("stone_brick_slab", Block::BlockSetting());
    const Block STONE_BRICK_STAIRS("stone_brick_stairs", Block::BlockSetting());
    const Block STONE_BRICK_WALL("stone_brick_wall", Block::BlockSetting());
    const Block STONE_BRICKS("stone_bricks", Block::BlockSetting());
    const Block STONE_BUTTON("stone_button", Block::BlockSetting());
    const Block STONE_PRESSURE_PLATE("stone_pressure_plate", Block::BlockSetting());
    const Block STONE_SLAB("stone_slab", Block::BlockSetting());
    const Block STONE_STAIRS("stone_stairs", Block::BlockSetting());
    const Block STONECUTTER("stonecutter", Block::BlockSetting());
    const Block STRIPPED_ACACIA_LOG("stripped_acacia_log", Block::BlockSetting());
    const Block STRIPPED_ACACIA_WOOD("stripped_acacia_wood", Block::BlockSetting());
    const Block STRIPPED_BAMBOO_BLOCK("stripped_bamboo_block", Block::BlockSetting());
    const Block STRIPPED_BIRCH_LOG("stripped_birch_log", Block::BlockSetting());
    const Block STRIPPED_BIRCH_WOOD("stripped_birch_wood", Block::BlockSetting());
    const Block STRIPPED_CHERRY_LOG("stripped_cherry_log", Block::BlockSetting());
    const Block STRIPPED_CHERRY_WOOD("stripped_cherry_wood", Block::BlockSetting());
    const Block STRIPPED_CRIMSON_HYPHAE("stripped_crimson_hyphae", Block::BlockSetting());
    const Block STRIPPED_CRIMSON_STEM("stripped_crimson_stem", Block::BlockSetting());
    const Block STRIPPED_DARK_OAK_LOG("stripped_dark_oak_log", Block::BlockSetting());
    const Block STRIPPED_DARK_OAK_WOOD("stripped_dark_oak_wood", Block::BlockSetting());
    const Block STRIPPED_JUNGLE_LOG("stripped_jungle_log", Block::BlockSetting());
    const Block STRIPPED_JUNGLE_WOOD("stripped_jungle_wood", Block::BlockSetting());
    const Block STRIPPED_MANGROVE_LOG("stripped_mangrove_log", Block::BlockSetting());
    const Block STRIPPED_MANGROVE_WOOD("stripped_mangrove_wood", Block::BlockSetting());
    const Block STRIPPED_OAK_LOG("stripped_oak_log", Block::BlockSetting());
    const Block STRIPPED_OAK_WOOD("stripped_oak_wood", Block::BlockSetting());
    const Block STRIPPED_PALE_OAK_LOG("stripped_pale_oak_log", Block::BlockSetting());
    const Block STRIPPED_PALE_OAK_WOOD("stripped_pale_oak_wood", Block::BlockSetting());
    const Block STRIPPED_SPRUCE_LOG("stripped_spruce_log", Block::BlockSetting());
    const Block STRIPPED_SPRUCE_WOOD("stripped_spruce_wood", Block::BlockSetting());
    const Block STRIPPED_WARPED_HYPHAE("stripped_warped_hyphae", Block::BlockSetting());
    const Block STRIPPED_WARPED_STEM("stripped_warped_stem", Block::BlockSetting());
    const Block STRUCTURE_BLOCK("structure_block", Block::BlockSetting());
    const Block STRUCTURE_VOID("structure_void", Block::BlockSetting());
    const Block SUGAR_CANE("sugar_cane", Block::BlockSetting());
    const Block SUNFLOWER("sunflower", Block::BlockSetting());
    const Block SUSPICIOUS_GRAVEL("suspicious_gravel", Block::BlockSetting());
    const Block SUSPICIOUS_SAND("suspicious_sand", Block::BlockSetting());
    const Block SWEET_BERRY_BUSH("sweet_berry_bush", Block::BlockSetting());
    const Block TALL_DRY_GRASS("tall_dry_grass", Block::BlockSetting());
    const Block TALL_GRASS("tall_grass", Block::BlockSetting());
    const Block TALL_SEAGRASS("tall_seagrass", Block::BlockSetting());
    const Block TARGET("target", Block::BlockSetting());
    const Block TERRACOTTA("terracotta", Block::BlockSetting());
    const Block TEST_BLOCK("test_block", Block::BlockSetting());
    const Block TEST_INSTANCE_BLOCK("test_instance_block", Block::BlockSetting());
    const Block TINTED_GLASS("tinted_glass", Block::BlockSetting());
    const Block TNT("tnt", Block::BlockSetting());
    const Block TORCH("torch", Block::BlockSetting());
    const Block TORCHFLOWER("torchflower", Block::BlockSetting());
    const Block TORCHFLOWER_CROP("torchflower_crop", Block::BlockSetting());
    const Block TRAPPED_CHEST("trapped_chest", Block::BlockSetting());
    const Block TRIAL_SPAWNER("trial_spawner", Block::BlockSetting());
    const Block TRIPWIRE("tripwire", Block::BlockSetting());
    const Block TRIPWIRE_HOOK("tripwire_hook", Block::BlockSetting());
    const Block TUBE_CORAL("tube_coral", Block::BlockSetting());
    const Block TUBE_CORAL_BLOCK("tube_coral_block", Block::BlockSetting());
    const Block TUBE_CORAL_FAN("tube_coral_fan", Block::BlockSetting());
    const Block TUBE_CORAL_WALL_FAN("tube_coral_wall_fan", Block::BlockSetting());
    const Block TUFF("tuff", Block::BlockSetting());
    const Block TUFF_BRICK_SLAB("tuff_brick_slab", Block::BlockSetting());
    const Block TUFF_BRICK_STAIRS("tuff_brick_stairs", Block::BlockSetting());
    const Block TUFF_BRICK_WALL("tuff_brick_wall", Block::BlockSetting());
    const Block TUFF_BRICKS("tuff_bricks", Block::BlockSetting());
    const Block TUFF_SLAB("tuff_slab", Block::BlockSetting());
    const Block TUFF_STAIRS("tuff_stairs", Block::BlockSetting());
    const Block TUFF_WALL("tuff_wall", Block::BlockSetting());
    const Block TURTLE_EGG("turtle_egg", Block::BlockSetting());
    const Block TWISTING_VINES("twisting_vines", Block::BlockSetting());
    const Block TWISTING_VINES_PLANT("twisting_vines_plant", Block::BlockSetting());
    const Block VAULT("vault", Block::BlockSetting());
    const Block VERDANT_FROGLIGHT("verdant_froglight", Block::BlockSetting());
    const Block VINE("vine", Block::BlockSetting());
    const Block VOID_AIR("void_air", Block::BlockSetting());
    const Block WALL_TORCH("wall_torch", Block::BlockSetting());
    const Block WARPED_BUTTON("warped_button", Block::BlockSetting());
    const Block WARPED_DOOR("warped_door", Block::BlockSetting());
    const Block WARPED_FENCE("warped_fence", Block::BlockSetting());
    const Block WARPED_FENCE_GATE("warped_fence_gate", Block::BlockSetting());
    const Block WARPED_FUNGUS("warped_fungus", Block::BlockSetting());
    const Block WARPED_HANGING_SIGN("warped_hanging_sign", Block::BlockSetting());
    const Block WARPED_HYPHAE("warped_hyphae", Block::BlockSetting());
    const Block WARPED_NYLIUM("warped_nylium", Block::BlockSetting());
    const Block WARPED_PLANKS("warped_planks", Block::BlockSetting());
    const Block WARPED_PRESSURE_PLATE("warped_pressure_plate", Block::BlockSetting());
    const Block WARPED_ROOTS("warped_roots", Block::BlockSetting());
    const Block WARPED_SIGN("warped_sign", Block::BlockSetting());
    const Block WARPED_SLAB("warped_slab", Block::BlockSetting());
    const Block WARPED_STAIRS("warped_stairs", Block::BlockSetting());
    const Block WARPED_STEM("warped_stem", Block::BlockSetting());
    const Block WARPED_TRAPDOOR("warped_trapdoor", Block::BlockSetting());
    const Block WARPED_WALL_HANGING_SIGN("warped_wall_hanging_sign", Block::BlockSetting());
    const Block WARPED_WALL_SIGN("warped_wall_sign", Block::BlockSetting());
    const Block WARPED_WART_BLOCK("warped_wart_block", Block::BlockSetting());
    const Block WATER("water", Block::BlockSetting());
    const Block WATER_CAULDRON("water_cauldron", Block::BlockSetting());
    const Block WAXED_CHISELED_COPPER("waxed_chiseled_copper", Block::BlockSetting());
    const Block WAXED_COPPER_BLOCK("waxed_copper_block", Block::BlockSetting());
    const Block WAXED_COPPER_BULB("waxed_copper_bulb", Block::BlockSetting());
    const Block WAXED_COPPER_DOOR("waxed_copper_door", Block::BlockSetting());
    const Block WAXED_COPPER_GRATE("waxed_copper_grate", Block::BlockSetting());
    const Block WAXED_COPPER_TRAPDOOR("waxed_copper_trapdoor", Block::BlockSetting());
    const Block WAXED_CUT_COPPER("waxed_cut_copper", Block::BlockSetting());
    const Block WAXED_CUT_COPPER_SLAB("waxed_cut_copper_slab", Block::BlockSetting());
    const Block WAXED_CUT_COPPER_STAIRS("waxed_cut_copper_stairs", Block::BlockSetting());
    const Block WAXED_EXPOSED_CHISELED_COPPER("waxed_exposed_chiseled_copper", Block::BlockSetting());
    const Block WAXED_EXPOSED_COPPER("waxed_exposed_copper", Block::BlockSetting());
    const Block WAXED_EXPOSED_COPPER_BULB("waxed_exposed_copper_bulb", Block::BlockSetting());
    const Block WAXED_EXPOSED_COPPER_DOOR("waxed_exposed_copper_door", Block::BlockSetting());
    const Block WAXED_EXPOSED_COPPER_GRATE("waxed_exposed_copper_grate", Block::BlockSetting());
    const Block WAXED_EXPOSED_COPPER_TRAPDOOR("waxed_exposed_copper_trapdoor", Block::BlockSetting());
    const Block WAXED_EXPOSED_CUT_COPPER("waxed_exposed_cut_copper", Block::BlockSetting());
    const Block WAXED_EXPOSED_CUT_COPPER_SLAB("waxed_exposed_cut_copper_slab", Block::BlockSetting());
    const Block WAXED_EXPOSED_CUT_COPPER_STAIRS("waxed_exposed_cut_copper_stairs", Block::BlockSetting());
    const Block WAXED_OXIDIZED_CHISELED_COPPER("waxed_oxidized_chiseled_copper", Block::BlockSetting());
    const Block WAXED_OXIDIZED_COPPER("waxed_oxidized_copper", Block::BlockSetting());
    const Block WAXED_OXIDIZED_COPPER_BULB("waxed_oxidized_copper_bulb", Block::BlockSetting());
    const Block WAXED_OXIDIZED_COPPER_DOOR("waxed_oxidized_copper_door", Block::BlockSetting());
    const Block WAXED_OXIDIZED_COPPER_GRATE("waxed_oxidized_copper_grate", Block::BlockSetting());
    const Block WAXED_OXIDIZED_COPPER_TRAPDOOR("waxed_oxidized_copper_trapdoor", Block::BlockSetting());
    const Block WAXED_OXIDIZED_CUT_COPPER("waxed_oxidized_cut_copper", Block::BlockSetting());
    const Block WAXED_OXIDIZED_CUT_COPPER_SLAB("waxed_oxidized_cut_copper_slab", Block::BlockSetting());
    const Block WAXED_OXIDIZED_CUT_COPPER_STAIRS("waxed_oxidized_cut_copper_stairs", Block::BlockSetting());
    const Block WAXED_WEATHERED_CHISELED_COPPER("waxed_weathered_chiseled_copper", Block::BlockSetting());
    const Block WAXED_WEATHERED_COPPER("waxed_weathered_copper", Block::BlockSetting());
    const Block WAXED_WEATHERED_COPPER_BULB("waxed_weathered_copper_bulb", Block::BlockSetting());
    const Block WAXED_WEATHERED_COPPER_DOOR("waxed_weathered_copper_door", Block::BlockSetting());
    const Block WAXED_WEATHERED_COPPER_GRATE("waxed_weathered_copper_grate", Block::BlockSetting());
    const Block WAXED_WEATHERED_COPPER_TRAPDOOR("waxed_weathered_copper_trapdoor", Block::BlockSetting());
    const Block WAXED_WEATHERED_CUT_COPPER("waxed_weathered_cut_copper", Block::BlockSetting());
    const Block WAXED_WEATHERED_CUT_COPPER_SLAB("waxed_weathered_cut_copper_slab", Block::BlockSetting());
    const Block WAXED_WEATHERED_CUT_COPPER_STAIRS("waxed_weathered_cut_copper_stairs", Block::BlockSetting());
    const Block WEATHERED_CHISELED_COPPER("weathered_chiseled_copper", Block::BlockSetting());
    const Block WEATHERED_COPPER("weathered_copper", Block::BlockSetting());
    const Block WEATHERED_COPPER_BULB("weathered_copper_bulb", Block::BlockSetting());
    const Block WEATHERED_COPPER_DOOR("weathered_copper_door", Block::BlockSetting());
    const Block WEATHERED_COPPER_GRATE("weathered_copper_grate", Block::BlockSetting());
    const Block WEATHERED_COPPER_TRAPDOOR("weathered_copper_trapdoor", Block::BlockSetting());
    const Block WEATHERED_CUT_COPPER("weathered_cut_copper", Block::BlockSetting());
    const Block WEATHERED_CUT_COPPER_SLAB("weathered_cut_copper_slab", Block::BlockSetting());
    const Block WEATHERED_CUT_COPPER_STAIRS("weathered_cut_copper_stairs", Block::BlockSetting());
    const Block WEEPING_VINES("weeping_vines", Block::BlockSetting());
    const Block WEEPING_VINES_PLANT("weeping_vines_plant", Block::BlockSetting());
    const Block WET_SPONGE("wet_sponge", Block::BlockSetting());
    const Block WHEAT("wheat", Block::BlockSetting());
    const Block WHITE_BANNER("white_banner", Block::BlockSetting());
    const Block WHITE_BED("white_bed", Block::BlockSetting());
    const Block WHITE_CANDLE("white_candle", Block::BlockSetting());
    const Block WHITE_CANDLE_CAKE("white_candle_cake", Block::BlockSetting());
    const Block WHITE_CARPET("white_carpet", Block::BlockSetting());
    const Block WHITE_CONCRETE("white_concrete", Block::BlockSetting());
    const Block WHITE_CONCRETE_POWDER("white_concrete_powder", Block::BlockSetting());
    const Block WHITE_GLAZED_TERRACOTTA("white_glazed_terracotta", Block::BlockSetting());
    const Block WHITE_SHULKER_BOX("white_shulker_box", Block::BlockSetting());
    const Block WHITE_STAINED_GLASS("white_stained_glass", Block::BlockSetting());
    const Block WHITE_STAINED_GLASS_PANE("white_stained_glass_pane", Block::BlockSetting());
    const Block WHITE_TERRACOTTA("white_terracotta", Block::BlockSetting());
    const Block WHITE_TULIP("white_tulip", Block::BlockSetting());
    const Block WHITE_WALL_BANNER("white_wall_banner", Block::BlockSetting());
    const Block WHITE_WOOL("white_wool", Block::BlockSetting());
    const Block WILDFLOWERS("wildflowers", Block::BlockSetting());
    const Block WITHER_ROSE("wither_rose", Block::BlockSetting());
    const Block WITHER_SKELETON_SKULL("wither_skeleton_skull", Block::BlockSetting());
    const Block WITHER_SKELETON_WALL_SKULL("wither_skeleton_wall_skull", Block::BlockSetting());
    const Block YELLOW_BANNER("yellow_banner", Block::BlockSetting());
    const Block YELLOW_BED("yellow_bed", Block::BlockSetting());
    const Block YELLOW_CANDLE("yellow_candle", Block::BlockSetting());
    const Block YELLOW_CANDLE_CAKE("yellow_candle_cake", Block::BlockSetting());
    const Block YELLOW_CARPET("yellow_carpet", Block::BlockSetting());
    const Block YELLOW_CONCRETE("yellow_concrete", Block::BlockSetting());
    const Block YELLOW_CONCRETE_POWDER("yellow_concrete_powder", Block::BlockSetting());
    const Block YELLOW_GLAZED_TERRACOTTA("yellow_glazed_terracotta", Block::BlockSetting());
    const Block YELLOW_SHULKER_BOX("yellow_shulker_box", Block::BlockSetting());
    const Block YELLOW_STAINED_GLASS("yellow_stained_glass", Block::BlockSetting());
    const Block YELLOW_STAINED_GLASS_PANE("yellow_stained_glass_pane", Block::BlockSetting());
    const Block YELLOW_TERRACOTTA("yellow_terracotta", Block::BlockSetting());
    const Block YELLOW_WALL_BANNER("yellow_wall_banner", Block::BlockSetting());
    const Block YELLOW_WOOL("yellow_wool", Block::BlockSetting());
    const Block ZOMBIE_HEAD("zombie_head", Block::BlockSetting());
    const Block ZOMBIE_WALL_HEAD("zombie_wall_head", Block::BlockSetting());
